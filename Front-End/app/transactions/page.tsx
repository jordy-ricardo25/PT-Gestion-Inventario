...
import { DeleteTransactionDialog } from '@lib/components/DeleteTransactionDialog';
    ...
    <main className="flex flex-col min-h-screen items-center justify-center">
      ...
      <section className="w-full p-6">
        <div className="rounded-2xl border bg-white p-4">
          <TransactionTable onDelete={setDeleting} />
        </div>
      </section>
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 p-4">
          <div className="w-full max-w-lg rounded-2xl border bg-white p-6 shadow-xl">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold">Crear transacción</h2>
              <button
